...
export default function Timeline({
    ...
    const ruler = () => {
        ...
        return <div className={`${styles.track} ${styles.ruler}`}>
                        <div style={{transform: `translateX(${currentTime * scaleFactor}px)`}} className={styles.pointer}
    ...
    const genTrack = (segments: Segment[], trackInd: number) => {
        ...
        for (let i = 0; i < segments.length; i++) {
            ...
            segmentDivs.push(<div style={{ flex: `0 0 ${space * scaleFactor}px` }} key={i}></div>);
                ...
                >
                    <div
                        ...
                        style={{
                            ...
                            border: `2px solid ${isSelected ? "#5A5AFF" : ""}`,
                            borderRadius: "11px",
    ...
    useEffect(() => {
        setTrackDivs(trackList.map((track, ind) => <div className={styles.track} key={ind.toString()} >{genTrack(track, ind)}</div>));
    ...
    return (
        ...
        {
            (provided) => (
                <div className="timeline" style={{overflowX:'scroll',scrollbarColor:'pink white',scrollbarWidth:'thin'}} {...provided.droppableProps} ref={provided.innerRef} >
